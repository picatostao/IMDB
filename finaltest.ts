...
persona.name=readlineSync.question("nombre:")
persona.age=readlineSync.question("edad:")
persona.weight=readlineSync.question("peso:")
persona.height=readlineSync.question("altura:")
persona.isRetired=readlineSync.question("retirado:")
persona.nationaly=readlineSync.question("nacionalidad:")
persona.oscarsNumber=readlineSync.question("oscars:")

let personain= JSON.stringify(persona)
let profesional_=JSON.parse(personain)
